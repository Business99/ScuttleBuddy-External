# Game
oGameTime: int = 0x3111E68
oViewProjMatrix: int = 0x3148A20
oRenderer: int = 0x314B90C
oGameWindowWidth: int = 0x8
oGameWindowHeight: int = 0xc

# Entities / Managers
oLocalPlayer: int = 0x3118DDC
oHeroManager: int = 0x187BF54

# Player Entity
oObjTeamId: int = 0x0034
oObjPlayerName: int = 0x54 + 30
oObjName: int = 0x2BD4
oObjLevel: int = 0x33B4
oObjPosition: int = 0x01DC  # Vector 3
